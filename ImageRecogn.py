...
img = mpimg.imread(f'mtn\\test_images_pack\\{random.randint(1,3)}.jpg')
...
prediction_web = model.predict(img_after)
...
print('Имя предсказанного класса:{0}'.format(class_names[np.argmax(prediction_web)]))
